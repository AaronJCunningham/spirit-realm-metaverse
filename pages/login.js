...
const contractAddress = "0xc92cEe868e90eC2053D5C80571a98eac8401c1AF";
...
export default function Login() {
  ...
  return (
    <div className="container">
      <h1 className="h1">Auth - NFT Gated Content</h1>
      <p className="explain">
      ...
      <>
        ...
        <button className="mainButton" style={{ width: 256 }} onClick={login}>
          Sign In
        </button>
