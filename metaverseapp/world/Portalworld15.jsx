...
export function PortalWorld(props) {
  ...
  const [frame02, setFrame02] = useState(null);
  const [frame03, setFrame03] = useState(null);
  const [frame04, setFrame04] = useState(null);
  const [frame05, setFrame05] = useState(null);
  const [frame06, setFrame06] = useState(null);
  const [frame07, setFrame07] = useState(null);
  const [frame08, setFrame08] = useState(null);

  const { scene, nodes, materials } = useGLTF("/world/world07.glb");
  ...
  useEffect(() => {
    ...
    setFrame02(scene.getObjectByName("frame02"));
    setFrame03(scene.getObjectByName("frame03"));
    setFrame04(scene.getObjectByName("frame04"));
    setFrame05(scene.getObjectByName("frame05"));
    setFrame06(scene.getObjectByName("frame06"));
    setFrame07(scene.getObjectByName("frame07"));
    setFrame08(scene.getObjectByName("frame08"));
  }, [scene]);
...
useGLTF.preload("/world/world07.glb");
